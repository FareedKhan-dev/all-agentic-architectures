...
class SelfRAG(Architecture):
    ...
    def _decide_retrieval(self, state: SelfRAGState) -> dict[str, Any]:
        try:
            ...
            return {
                ...
                "history": [{"stage": "decide_retrieval", "needs_retrieval": d.needs_retrieval, "rationale": d.rationale}],
            }
        except Exception:
    ...
    def build(self) -> Any:
        ...
        g.add_conditional_edges(
            "decide_retrieval", self._after_decide,
            {"retrieve": "retrieve", "answer": "answer"},
        )
        g.add_conditional_edges(
            "retrieve", self._after_retrieve,
